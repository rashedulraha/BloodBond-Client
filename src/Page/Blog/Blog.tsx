...
const BlogCard: React.FC<{ post: BlogPost }> = ({ post }) => (
  <div className="bg-card/50 rounded-md  border border-border overflow-hidden transition-all duration-300 hover:-translate-y-1">
    ...
    <Container>
      <div className="min-h-screen">
        <div className="space-y-12">
          ...
          {featuredPost && (
            <div className="bg-card/50 p-6 md:p-10 rounded-md shadow-2xl border border-primary/20 flex flex-col lg:flex-row gap-8 transition-all duration-300">
          ...
          <div className="space-y-6 pt-6">
            ...
            {/* Filter Buttons */}
            <div className="flex flex-wrap items-center gap-3 p-3 bg-card/50 rounded-lg border border-secondary">
