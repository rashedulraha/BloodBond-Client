  ...
  return (
    <div className="bg-background min-h-screen py-8">
      <Container>
        {/* Header */}
        <div
          className="text-center pt-4 pb-6 border-b border-border mb-8"
          data-aos="fade-down">
        ...
        {/* Search Card & Form */}
        <div
          className="bg-card p-4 md:p-6 lg:p-8 rounded-lg shadow-lg border border-primary/30 max-w-5xl mx-auto mb-8"
          data-aos="fade-up"
          data-aos-delay="200">
